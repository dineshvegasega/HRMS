...
@HiltViewModel
class ScoreCategoriesVM @Inject constructor(private val repository: Repository): ViewModel() {
    fun recruitmentsList(callBack: ItemLeaveRequest.() -> Unit) = viewModelScope.launch {
        repository.callApi(
...
//                        showSnackBar(response.body()!!.message)
    ...
    val recruitmentsAdapter = object : GenericAdapter<ItemPoliciesBinding, Data>() {
