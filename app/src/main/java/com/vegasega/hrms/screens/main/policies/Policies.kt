...
//                Log.e("TAG", "btCheckOut " + token)
                ...
                binding.recyclerView.adapter = viewModel.policiesAdapter
                viewModel.policiesList() {
                    viewModel.policiesAdapter.notifyDataSetChanged()
                    viewModel.policiesAdapter.submitList(this.data)
                }
