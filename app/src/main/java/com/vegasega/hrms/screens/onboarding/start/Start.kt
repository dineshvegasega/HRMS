package com.vegasega.hrms.screens.onboarding.start
...
import com.vegasega.hrms.databinding.StartBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            btSignIn.singleClick {
                    view.findNavController().navigate(R.id.action_onboarding_to_onBoard)
            }
