package com.vegasega.hrms.screens.main.NBPA
...
import com.vegasega.hrms.databinding.DialogFilterBinding
import com.vegasega.hrms.databinding.NbpaListBinding
import com.vegasega.hrms.networking.USER_TYPE
import com.vegasega.hrms.networking.USER_TYPE_ADMIN
import com.vegasega.hrms.networking.filterByAadhaar
import com.vegasega.hrms.networking.filterByEndDate
import com.vegasega.hrms.networking.filterByMobile
import com.vegasega.hrms.networking.filterByName
import com.vegasega.hrms.networking.filterByStartDate
import com.vegasega.hrms.networking.user_id
import com.vegasega.hrms.networking.user_type
import com.vegasega.hrms.screens.mainActivity.MainActivity
//import com.vegasega.hrms.screens.main.products.ProductsVM.Companion.isFilterLoad
//import com.vegasega.hrms.screens.main.products.ProductsVM.Companion.isProductLoad
import com.vegasega.hrms.screens.mainActivity.MainActivityVM.Companion.isFilterLoad
    ...
    fun filters(
        ...
        if (userType == USER_TYPE) {
            obj = JSONObject().apply {
                put(com.vegasega.hrms.networking.page, "" + page)
